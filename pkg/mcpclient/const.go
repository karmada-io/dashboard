...
const (
	// McpClientName defines the name identifier for the Karmada Dashboard MCP client.
	McpClientName = "Karmada-Dashboard-MCP-Client"
	// McpClientVersion defines the version identifier for the MCP client implementation.
