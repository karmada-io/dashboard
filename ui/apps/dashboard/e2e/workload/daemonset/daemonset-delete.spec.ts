...
test('should delete daemonset successfully', async ({ page }) => {
    ...
    await deleteWorkloadResourceTest(page, {
        ...
        tabName: 'Daemonset',
        apiEndpointPattern: '/_raw/daemonset',
        yamlContent: testDaemonSetYaml,
        getResourceName: getDaemonSetNameFromYaml,
        createResource: createK8sDaemonSet,
        screenshotName: 'debug-daemonset-delete-kubectl.png'
    });
});
