...
spec:
  ...
  overrideRules:
    ...
    try {
        ...
        console.warn(`Failed to cleanup overridepolicy ${clusterOverridePolicyName}:`, error);
    }

    // Debug
    if (process.env.DEBUG === 'true') {
        await page.screenshot({ path: 'debug-cluster-overridepolicy-edit.png', fullPage: true });
    }
