...
import { setupDashboardAuthentication, generateTestOverridePolicyYaml, createK8sOverridePolicy, getOverridePolicyNameFromYaml, deleteK8sOverridePolicy } from './test-utils';
...
spec:
  ...
  overrideRules:
    ...
    if (process.env.DEBUG === 'true') {
        await page.screenshot({ path: 'debug-overridepolicy-namespace-edit.png', fullPage: true });
    }
