...
test('should delete member cluster successfully', async ({ page }) => {
    ...
    await deleteMemberClusterTest(page, {
        yamlContent: testMemberClusterYaml,
        getClusterName: getMemberClusterNameFromResourceYaml,
        createCluster: createK8sMemberCluster,
        deleteCluster: deleteK8sMemberCluster,
        screenshotName: 'debug-membercluster-delete.png'
    });
});
