...
function getTitle(mode: PropagationPolicyEditorDrawerProps['mode'], name: string = '') {
    switch (mode) {
        case "create":
            return '新增调度策略';
        case "edit":
...
const PropagationPolicyEditorDrawer: FC<PropagationPolicyEditorDrawerProps> = (props) => {
    const {
        open, mode, name,
        namespace, propagationContent,
