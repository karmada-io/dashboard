...
export interface ClusterScopedFormProps {
 ...
 * 集群级调度策略表单
 */
const ClusterScopedForm: FC<ClusterScopedFormProps> = (props) => {
  ...
  const generateYaml = (values: any, template: any) => {
    try {
      console.log('集群级策略表单生成YAML，输入值:', values);
...
export default ClusterScopedForm; 